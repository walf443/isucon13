...
type NGWordRepository interface {
	...
	FindAllByLivestreamID(ctx context.Context, q Querier, livestreamID model.LivestreamID) ([]*model.NGWordModel, error)
	...
	Create(ctx context.Context, q Querier, ngWord *model.NGWordModel) (model.NGWordID, error)
}
