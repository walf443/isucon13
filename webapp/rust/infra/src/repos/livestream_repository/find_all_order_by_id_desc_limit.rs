...
async fn returns_limited_rows() {
    ...
    sqlx::query(
        "INSERT INTO livestreams (id, user_id, title, description, playlist_url, thumbnail_url, start_at, end_at) VALUES (1, 1, 't1', 'd1', 'http://p', 'http://t', 1000, 2000), (2, 1, 't2', 'd2', 'http://p2', 'http://t2', 3000, 4000), (3, 1, 't3', 'd3', 'http://p3', 'http://t3', 5000, 6000)",
    )
    .execute(&mut *tx)
    .await
    .unwrap();
